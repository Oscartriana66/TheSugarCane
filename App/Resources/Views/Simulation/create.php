...
<div class="container px-5 pt-5">
	...
	<form class="form-simulation" method="post" action="<?php echo URL; ?>/Simulation/New">
		...
		<div class="row">
			<div class="col-12 mb-3">
				<div class="form-group">
					...
					<input type="text" class="form-control show_options" data-url="<?php echo URL; ?>/Variety/find_by_select" name="variedad" id="variedad" placeholder="Ingrese la variedad para realizar la simulación" class="py-5" autocomplete="off" >
					<input type="hidden" class="show_options_2" name="variety_id" id="variety_id" value="">
				</div>
			</div>
			<div class="col-md-6 mb-3">
				<div class="form-group">
					<label for="" style="position: absolute; color: #009688; font-size: 12px; left: 25px; top: 3px;">Número de hectareas sembradas</label>
					<input type="number" step="0.1" min="0" class="form-control" name="number_hectares_planted" id="number_hectares_planted" placeholder="Número de hectareas sembradas" class="py-5" autocomplete="off" value="">
				</div>
			</div>
			<div class="col-md-6 mb-3">
				<div class="form-group">
					<label for="" style="position: absolute; color: #009688; font-size: 12px; left: 25px; top: 3px;">Calidad del suelo (porcentaje 0 - 100)</label>
					<input type="number" step="1" min="0" max="100" class="form-control" name="soil_quality" id="soil_quality" placeholder="Calidad del suelo (porcentaje)" class="py-5" autocomplete="off" value="">
				</div>
			</div>
			<div class="col-md-6 mb-3">
				<div class="form-group">
					<label for="" style="position: absolute; color: #009688; font-size: 12px; left: 25px; top: 3px;">Precipitaciones totales</label>
					<input type="number" step="0.1" min="0"  class="form-control" name="total_rainfall" id="total_rainfall" placeholder="Precipitaciones totales" class="py-5" autocomplete="off" value="">
				</div>
			</div>
			<div class="col-md-6 mb-3">
				<div class="form-group">
					...
					<input type="number" step="0.1" min="0"  class="form-control" name="average_temperature_area" id="average_temperature_area" placeholder="Temperatura promedio de la zona (centigrados)" class="py-5" autocomplete="off" value="">
				</div>
			</div>
			<div class="col-md-6 mb-3 mb-md-0">
				<div class="form-group">
					...
					<input type="number" step="0.1" min="0"  class="form-control" name="harvest" id="harvest" placeholder="Recoleccion (número de meses desde el cultivo)" class="py-5" autocomplete="off" value="">
				</div>
			</div>
			<div class="col-md-6 mb-3 mb-md-0">
				<div class="form-group">
...
<div id="content-calculos-previos" class="container p-5 d-none">
	<div class="row">
		<div class="col-12 mb-4">
			<h4 class="font-weight-bold" style="color: #008000;">
				Cálculos previos
